                            ...
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <%
                                            String added = "";
                                            if (session.getAttribute("updateexpert") != null) {
                                                added = (String) session.getAttribute("updateexpert");
                                                if (added.contains("not")) {
                                                    added = "<strong>Expert Not Updated!</strong> Please try again.";
                                                } else {
                                                    added = "<strong>Expert Updated Successfully..</strong> ";
                                                }
                                                session.removeAttribute("updateexpert");
                                        %>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" id="expertName" name="expertName" id="expertSearch" placeholder="Search expert...">
                                                        </div>
                                                        <span class="col-sm-3 input-group-btn">
                                                            <button class="btn btn-success mr-2 expertButton" type="button">Search!</button>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
